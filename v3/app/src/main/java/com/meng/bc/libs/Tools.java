...
import com.meng.bc.activity.live.*;
...
public class Tools {
	...
	public static class BilibiliTool {
		...
		public static String getUserInfo(long id) {
			return Tools.Network.getSourceCode("https://api.bilibili.com/x/space/acc/info?mid=" + id + "&jsonp=jsonp", SJFSettings.getCookie());
		}

		public static String getLiveRoomFromUid(long uid) {
