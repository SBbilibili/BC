		...
		MainActivity.instance.threadPool.execute(new Runnable(){
				...
				public void run() {
					try {
						...
						UidToLiveRoom sjb = MainActivity.instance.gson.fromJson(Tools.BilibiliTool.getLiveRoomFromUid(id), UidToLiveRoom.class);
						...
						notifyList();
						if (id == SJFSettings.getUID()) {
							addData("cookie", SJFSettings.getCookie());
							notifyList();
						}
					} catch (Exception e) {
						e.printStackTrace();
